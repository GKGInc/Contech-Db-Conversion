...
--SET IDENTITY_INSERT [Contech_Test].[dbo].[jobsetup] ON;
...
--  LEFT JOIN [Contech_Test].[dbo].[orders] ON [rawUpsize_Contech].[dbo].[jobsetup].[job_no] = [Contech_Test].[dbo].[orders].[job_no]		-- FK = [orders].[job_no] --> [orders].[ordersid]
  
--SET IDENTITY_INSERT [Contech_Test].[dbo].[jobsetup] OFF;
...
--SET IDENTITY_INSERT [Contech_Test].[dbo].[lab001] ON;

--INSERT INTO [Contech_Test].[dbo].[lab001] ([lab001id],[shppack_id],[ordersid],[add_dt],[add_dt],[userid])
...
--  LEFT JOIN [Contech_Test].[dbo].[orders] ON [rawUpsize_Contech].[dbo].[lab001].[job_no] = [Contech_Test].[dbo].[orders].[job_no]		-- FK = [orders].[job_no] --> [orders].[ordersid]
--  LEFT JOIN [Contech_Test].[dbo].[users] ON [rawUpsize_Contech].[dbo].[lab001].[add_user] = [Contech_Test].[dbo].[users].[username]	-- FK = [users].[userid]

--SET IDENTITY_INSERT [Contech_Test].[dbo].[lab001] OFF;
