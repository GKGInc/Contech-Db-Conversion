...
SET IDENTITY_INSERT [cyclcomp] ON;

INSERT INTO [cyclcomp] ([cyclcompid],[inv_sessid],[componetid])
...
SET IDENTITY_INSERT [cyclcomp] OFF;

--SELECT * FROM [cyclcomp]
...
INSERT INTO [disposit] ([dispos],[descript])
SELECT [dispos]
      ,[descript]
  FROM [rawUpsize_Contech].[dbo].[disposit]
  
--SELECT * FROM [disposit]
...
SELECT [rawUpsize_Contech].[dbo].[doc_mngr].[doc_mngrid]
  ...
  LEFT JOIN [users] add_user ON [rawUpsize_Contech].[dbo].[doc_mngr].[add_user] = add_user.[username]	-- FK = [users].[userid]
  LEFT JOIN [users] mod_user ON [rawUpsize_Contech].[dbo].[doc_mngr].[mod_user] = mod_user.[username]	-- FK = [users].[userid]
    
SET IDENTITY_INSERT [doc_mngr] OFF;

--SELECT * FROM [doc_mngr]

-- =========================================================
-- Section 030: docs_dtl
-- =========================================================
...
SET IDENTITY_INSERT [docs_dtl] ON;

INSERT INTO [docs_dtl] ([docs_dtlid],[doctype],[series],[extension],[document],[descript],[rev],[rev_date],[move_date],[docmod],[docs_hdrid],[cpmr_rev],[cpmr_date],[rev_rec],[rev_dt],[rev_employeeid])
SELECT [rawUpsize_Contech].[dbo].[docs_dtl].[docs_dtlid]
  ...
  LEFT JOIN [employee] employee ON [rawUpsize_Contech].[dbo].[docs_dtl].[rev_emp] = employee.[empnumber]	
  
SET IDENTITY_INSERT [docs_dtl] OFF;

--SELECT * FROM [docs_dtl]

-- =========================================================
-- Section 030: docs_hdr
-- =========================================================
...
SET IDENTITY_INSERT [docs_hdr] ON;

INSERT INTO [docs_hdr] ([docs_hdrid],[doctypeid],[series],[descript])
...
SET IDENTITY_INSERT [docs_hdr] OFF;

--SELECT * FROM [docs_hdr]
